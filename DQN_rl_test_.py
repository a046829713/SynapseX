...
def creaet_strategy(model_path:str,symbol:str):
    ...
    strategy.load_data(local_data_path=f'simulation\data\{symbol}-F-{data_len}-Min.csv')
    return strategy

# KSMUSDT is very special
strategy = creaet_strategy('DQN\Meta\Meta-300B-30K.pt', symbol='TRBUSDT') # KSMUSDT TRBUSDT MKRUSDT
