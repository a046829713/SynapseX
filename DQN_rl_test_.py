...
def creaet_strategy(model_path:str,symbol:str):
    ...
    strategy.load_data(local_data_path=f'Brain\simulation\data\{symbol}-F-{data_len}-Min.csv')
    return strategy

# KSMUSDT is very special
strategy = creaet_strategy('Brain\DQN\Meta\Meta-300B-30K.pt', symbol='BTCUSDT') # KSMUSDT TRBUSDT MKRUSDT
