...
class DAIN_Layer(nn.Module):
    def __init__(self, mode='full', mean_lr=0.00001, gate_lr=0.001, scale_lr=0.00001, input_dim=None):
        ...
        # 確保 input_dim 是必需的
        assert input_dim is not None, "You must specify `input_dim` as the number of features in your input!"
