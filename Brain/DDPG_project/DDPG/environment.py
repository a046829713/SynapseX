...
class Env:
    def __init__(self, bars_count: int, commission_perc: float, default_slippage: float, prices: dict, random_ofs_on_reset: bool, device: torch.device):
        self.bars_count = bars_count
